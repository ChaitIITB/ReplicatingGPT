...
class GPT(nn.Module):
    ...
    def forward(self, idx: int, targets: int =None):
        ...
        print(f"type of x in forward is {type(x)}")
    ...
    def from_pretrained(cls, model_type):
        ...
        sd_hf = model_hf.state_dict()        # copy while ensuring all of the parameters are aligned and match in names and shapes
...
for i in range(num_return_sequences):
    ...
    decoded_output = enc.decode(tokens)
